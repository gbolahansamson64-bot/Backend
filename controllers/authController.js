...
const mergeGuestCartIntoUserCart = async (req, res, user) => {
  try {
    ...
    // --------------------------------------------------------
    // USER HAS NO CART
    // Simply convert the guest cart into the user's cart
    // --------------------------------------------------------
...
// Merge guest cart into the newly created account
...
// Merge guest cart into the customer's existing cart
await mergeGuestCartIntoUserCart(
    req,
    res,
    user
